...
public class InsurancePlanDto extends BaseDto<InsurancePlanDto> {
	...
	private String insurancePlanOriginalName;
	...
	public InsurancePlanDto(InsurancePlanDto dto) {
		...
		this.insurancePlanOriginalName = dto.insurancePlanOriginalName;
	...
	public boolean equalsAll(InsurancePlanDto other) {
		...
		if(other!=null) {
			...
			result = result&&dtoUtils.equals("insurancePlanOriginalName", insurancePlanOriginalName, other.insurancePlanOriginalName);
	...
	public String getInsurancePlanOriginalName() {
		return insurancePlanOriginalName;
	}

	public void setInsurancePlanOriginalName(String insurancePlanOriginalName) {
		this.insurancePlanOriginalName = insurancePlanOriginalName;
	}
