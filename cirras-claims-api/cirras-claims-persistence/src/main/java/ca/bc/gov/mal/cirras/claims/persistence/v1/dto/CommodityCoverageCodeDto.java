...
public class CommodityCoverageCodeDto extends BaseDto<CommodityCoverageCodeDto> {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(CommodityCoverageCodeDto.class);
	...
	public CommodityCoverageCodeDto() {
	}
	
	
	public CommodityCoverageCodeDto(CommodityCoverageCodeDto dto) {
	...
	@Override
	public boolean equalsBK(CommodityCoverageCodeDto other) {
		throw new UnsupportedOperationException("Not Implemented");
	}

	@Override
	public boolean equalsAll(CommodityCoverageCodeDto other) {
		...
		if(other!=null) {
			...
			result = result&&dtoUtils.equals("perilCode", commodityCoverageCode, other.commodityCoverageCode);
	...
	@Override
	public CommodityCoverageCodeDto copy() {
		return new CommodityCoverageCodeDto(this);
	}
