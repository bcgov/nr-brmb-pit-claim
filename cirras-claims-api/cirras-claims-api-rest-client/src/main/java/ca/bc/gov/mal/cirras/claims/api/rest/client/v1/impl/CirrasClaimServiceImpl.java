package ca.bc.gov.mal.cirras.claims.api.rest.client.v1.impl;
...
public class CirrasClaimServiceImpl extends BaseRestServiceClient implements CirrasClaimService {
	 ...
	 */
	public CirrasClaimServiceImpl(String webadeOauth2ClientId, String webadeOauth2ClientSecret, String webadeOauth2TokenUrl, String scopes) {
	 ...
	 * @param webadeOauth2ClientSecret
	 */
	public CirrasClaimServiceImpl(String webadeOauth2ClientId, String webadeOauth2ClientSecret) {
	 ...
	 * @param headerValue
	 */
	public CirrasClaimServiceImpl(String headerValue) {
		super(headerValue);
		logger.debug("<CirrasClaimServiceImpl");
