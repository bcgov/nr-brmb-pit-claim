...
import ca.bc.gov.mal.cirras.claims.controllers.publisher.NatsAuthHandler;
import ca.bc.gov.mal.cirras.claims.controllers.publisher.NatsConnectionListener;
import ca.bc.gov.mal.cirras.claims.controllers.publisher.NatsErrorListener;
...
public class EventPublisherSpringConfig  {
	...
	@Value("${MESSAGE_QUEUE_CLAIMS_REST_NKEY_SEED}")
	...
	public EventPublisher eventPublisher() {
		...
		result.setMessageQueueSubject("claims-event-channel");
