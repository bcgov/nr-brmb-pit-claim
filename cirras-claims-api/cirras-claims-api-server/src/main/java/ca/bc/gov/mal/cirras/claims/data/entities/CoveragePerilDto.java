...
public class CoveragePerilDto extends BaseDto<CoveragePerilDto> {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(CoveragePerilDto.class);
	...
	public CoveragePerilDto() {
	}
	
	
	public CoveragePerilDto(CoveragePerilDto dto) {
		this.coveragePerilId = dto.coveragePerilId;
		this.cropCommodityId = dto.cropCommodityId;
		this.perilCode = dto.perilCode;
	...
	@Override
	public boolean equalsBK(CoveragePerilDto other) {
		throw new UnsupportedOperationException("Not Implemented");
	}

	@Override
	public boolean equalsAll(CoveragePerilDto other) {
		...
		if(other!=null) {
			...
			result = result&&dtoUtils.equals("perilCode", perilCode, other.perilCode);
	...
	@Override
	public CoveragePerilDto copy() {
		return new CoveragePerilDto(this);
	}
