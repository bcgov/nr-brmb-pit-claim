...
import ca.bc.gov.mal.cirras.claims.data.repositories.mapper.ClaimCalculationBerriesMapper;
...
@Repository
public class ClaimCalculationBerriesDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(ClaimCalculationBerriesDao.class);
