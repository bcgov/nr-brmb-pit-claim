...
import ca.bc.gov.mal.cirras.claims.data.repositories.mapper.ClaimCalculationMapper;
...
@Repository
public class ClaimCalculationDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(ClaimCalculationDao.class);
