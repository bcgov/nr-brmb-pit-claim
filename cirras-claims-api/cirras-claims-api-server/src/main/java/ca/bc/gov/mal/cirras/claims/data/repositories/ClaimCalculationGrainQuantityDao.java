...
import ca.bc.gov.mal.cirras.claims.data.repositories.mapper.ClaimCalculationGrainQuantityMapper;
...
@Repository
public class ClaimCalculationGrainQuantityDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(ClaimCalculationGrainQuantityDao.class);
