...
public class FetchOutboxTask extends AsynchronousTimerTask {
	...
	private CirrasClaimsOutboxService cirrasClaimsOutboxService;
	...
	public void run() {
		...
		try {
			...
			for ( OutboxProcessor op : outboxProcessorList ) {
				op.process(authentication, cirrasClaimsOutboxService);
			}
	...
	public void setCirrasClaimsOutboxService(CirrasClaimsOutboxService cirrasClaimsOutboxService) {
		this.cirrasClaimsOutboxService = cirrasClaimsOutboxService;
	}
	
	public void setCirrasClaimsOutboxServicePublishAndDelete(boolean publishAndDelete) {
		this.cirrasClaimsOutboxService.setPublishAndDelete(publishAndDelete);
	}
