...
import ca.bc.gov.mal.cirras.claims.data.repositories.mapper.ClaimCalculationGrainSpotLossMapper;
...
@Repository
public class ClaimCalculationGrainSpotLossDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(ClaimCalculationGrainSpotLossDao.class);
