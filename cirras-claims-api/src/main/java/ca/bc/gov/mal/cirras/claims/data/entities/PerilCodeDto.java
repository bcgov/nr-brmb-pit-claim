...
public class PerilCodeDto extends BaseDto<PerilCodeDto> {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(PerilCodeDto.class);
	...
	public PerilCodeDto(PerilCodeDto dto) {
	...
	@Override
	public boolean equalsBK(PerilCodeDto other) {
		throw new UnsupportedOperationException("Not Implemented");
	}

	@Override
	public boolean equalsAll(PerilCodeDto other) {
	...
	@Override
	public PerilCodeDto copy() {
		return new PerilCodeDto(this);
	}
