...
import ca.bc.gov.mal.cirras.claims.data.repositories.mapper.ClaimCalculationGrainBasketProductMapper;
...
@Repository
public class ClaimCalculationGrainBasketProductDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(ClaimCalculationGrainBasketProductDao.class);
