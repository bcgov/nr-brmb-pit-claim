...
import ca.bc.gov.mal.cirras.claims.data.repositories.mapper.ClaimCalculationUserMapper;
...
@Repository
public class ClaimCalculationUserDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(ClaimCalculationUserDao.class);
