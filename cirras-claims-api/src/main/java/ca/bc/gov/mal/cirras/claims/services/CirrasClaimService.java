...
import ca.bc.gov.mal.cirras.claims.data.models.ClaimCalculationGrainBasket;
import ca.bc.gov.mal.cirras.claims.data.models.ClaimCalculationGrainBasketProduct;
import ca.bc.gov.mal.cirras.claims.data.models.ClaimCalculationGrainQuantity;
...
import ca.bc.gov.mal.cirras.claims.data.models.ClaimCalculationList;
...
import ca.bc.gov.mal.cirras.claims.data.entities.ClaimCalculationGrainBasketProductDto;
...
public class CirrasClaimService {
	...
	// factories
	private ClaimRsrcFactory claimRsrcFactory;
	...
	public void setClaimRsrcFactory(ClaimRsrcFactory claimRsrcFactory) {
		this.claimRsrcFactory = claimRsrcFactory;
	}
	...
	public ClaimList<? extends Claim> getClaimList(Integer claimNumber, String policyNumber,
		...
		try {
			...
			results = claimRsrcFactory.getClaimList(dtos, claimNumber, policyNumber, calculationStatusCode,
	...
	public ClaimCalculation getClaim(String claimNumber, FactoryContext context, WebAdeAuthentication authentication)
		...
		try {
			...
			result = claimCalculationRsrcFactory.getCalculationFromClaim(policyClaimRsrc, 
					                                                 productRsrc, 
					                                                 crpDto, 
					                                                 linkedCrpDto, 
					                                                 verifiedYieldRsrc, 
	...
	public ClaimCalculation createClaimCalculation(ClaimCalculation claimCalculation, FactoryContext factoryContext,
		...
		try {
			...
			ClaimCalculationDto dto = claimCalculationRsrcFactory.createDto(claimCalculation);
	...
	private void createPlantAcres(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getCommodityCoverageCode().equalsIgnoreCase(ClaimsServiceEnums.CommodityCoverageCodes.Plant.getCode())
			...
			ClaimCalculationPlantAcresDto dtoPlantAcres = claimCalculationRsrcFactory
	...
	private void createPlantUnits(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getCommodityCoverageCode().equalsIgnoreCase(ClaimsServiceEnums.CommodityCoverageCodes.Plant.getCode())
			...
			ClaimCalculationPlantUnitsDto dtoPlantUnits = claimCalculationRsrcFactory
	...
	private void createGrapesQuantity(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAPES.toString())
			...
			ClaimCalculationGrapesDto dtoGrapes = claimCalculationRsrcFactory.createDto(claimCalculation.getClaimCalculationGrapes());
	...
	private void createGrainUnseeded(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAIN.toString())
			...
			ClaimCalculationGrainUnseededDto dtoGrapes = claimCalculationRsrcFactory.createDto(claimCalculation.getClaimCalculationGrainUnseeded());
	...
	private void createGrainSpotLoss(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAIN.toString())
			...
			ClaimCalculationGrainSpotLossDto dtoGrainSpotLoss = claimCalculationRsrcFactory.createDto(claimCalculation.getClaimCalculationGrainSpotLoss());
	...
	private void createGrainQuantity(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAIN.toString())
			...
			ClaimCalculationGrainQuantityDto dtoGrainQuantity = claimCalculationRsrcFactory.createDto(claimCalculation.getClaimCalculationGrainQuantity());
	...
	private void createGrainQuantityDetail(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAIN.toString())
			...
			ClaimCalculationGrainQuantityDetailDto dtoGrainQuantityDetail = claimCalculationRsrcFactory.createDto(claimCalculation.getClaimCalculationGrainQuantityDetail());
	...
	private void createGrainBasket(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAIN.toString())
			...
			ClaimCalculationGrainBasketDto dtoGrainBasket = claimCalculationRsrcFactory.createDto(claimCalculation.getClaimCalculationGrainBasket());
	...
	private void createGrainBasketProducts(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAIN.toString())
			...
			for ( ClaimCalculationGrainBasketProduct modelGrainBasketProduct : claimCalculation.getClaimCalculationGrainBasketProducts() ) {
				ClaimCalculationGrainBasketProductDto dtoGrainBasketProduct = claimCalculationRsrcFactory.createDto(modelGrainBasketProduct);
	...
	private void createBerriesQuantity(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.BERRIES.toString())
			...
			ClaimCalculationBerriesDto dtoBerries = claimCalculationRsrcFactory.createDto(claimCalculation.getClaimCalculationBerries());
	...
	private void createVarieties(ClaimCalculation claimCalculation, String userId, String claimCalculationGuid, Boolean deleteRecords)
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAPES.toString())){
			...
			for (ClaimCalculationVariety modelVariety : claimCalculation.getVarieties()) {
				ClaimCalculationVarietyDto dtoVariety = claimCalculationRsrcFactory.createDto(modelVariety);
	...
	public ClaimCalculation getClaimCalculation(String claimCalculationGuid, Boolean doRefreshManualClaimData,
		...
		try {
			...
			result = claimCalculationRsrcFactory.getClaimCalculation(dto, quantityClaimMap, factoryContext, authentication);
	...
	private void updateFromLinkedCalculation(ClaimCalculation claimCalculation, InsuranceClaimRsrc policyClaimRsrc, ProductListRsrc productListRsrc, CropCommodityDto linkedCrpDto, boolean doUpdateGrainQuantity) throws DaoException {
		...
		claimCalculationRsrcFactory.updateCalculationFromLinkedCalculation(claimCalculation, linkedProductRsrc, linkedClaimDto, currLinkedClaimCalcDto, latestLinkedClaimCalcDto, doUpdateGrainQuantity);
	}
	...
	private void updatePlantAcres(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationPlantAcres() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoPlantAcres, claimCalculation.getClaimCalculationPlantAcres());
	...
	private void updatePlantUnits(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationPlantUnits() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoPlantUnits, claimCalculation.getClaimCalculationPlantUnits());
	...
	private void updateGrapesQuantity(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationGrapes() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoGrapes, claimCalculation.getClaimCalculationGrapes());
	...
	private void updateGrainUnseededQuantity(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationGrainUnseeded() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoGrainUnseeded, claimCalculation.getClaimCalculationGrainUnseeded());
	...
	private void updateGrainSpotLoss(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationGrainSpotLoss() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoGrainSpotLoss, claimCalculation.getClaimCalculationGrainSpotLoss());
	...
	private void updateGrainQuantity(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationGrainQuantity() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoGrainQuantity, claimCalculation.getClaimCalculationGrainQuantity());
	...
	private void updateGrainQuantityDetail(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationGrainQuantityDetail() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoGrainQuantityDetail, claimCalculation.getClaimCalculationGrainQuantityDetail());
	...
	private void updateGrainBasket(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationGrainBasket() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoGrainBasket, claimCalculation.getClaimCalculationGrainBasket());
	...
	private void updateBerriesQuantity(ClaimCalculation claimCalculation, String userId)
		...
		if (claimCalculation.getClaimCalculationBerries() != null) {
			...
			claimCalculationRsrcFactory.updateDto(dtoBerries, claimCalculation.getClaimCalculationBerries());
	...
	private ClaimCalculation replaceClaimCalculation(ClaimCalculation claimCalculation, String updateType,
		...
		if (claimCalculation.getInsurancePlanName().equalsIgnoreCase(ClaimsServiceEnums.InsurancePlans.GRAIN.toString()) && 
			...
			if(quantityDto == null) {
				...
				result.setClaimCalculationGrainQuantity(claimCalculationRsrcFactory.createClaimCalculationGrainQuantity(quantityDto));
	...
	public ClaimCalculationList<? extends ClaimCalculation> getClaimCalculationList(Integer claimNumber,
		...
		try {
			...
			results = claimCalculationRsrcFactory.getClaimCalculationList(dtos, claimNumber, policyNumber, cropYear,
					calculationStatusCode, createClaimCalcUserGuid, updateClaimCalcUserGuid, insurancePlanId,
					sortColumn, sortDirection, pageRowCount, context, authentication);
