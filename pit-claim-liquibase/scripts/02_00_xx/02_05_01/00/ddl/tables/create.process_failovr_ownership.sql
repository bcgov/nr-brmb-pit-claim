...
;
COMMENT ON COLUMN ccs.process_failovr_ownership.create_user IS 'Create User is the user id of the user that created the record'
;
COMMENT ON COLUMN ccs.process_failovr_ownership.create_date IS 'Create Date is the date when the record was created.'
;
COMMENT ON COLUMN ccs.process_failovr_ownership.update_user IS 'Update User is the user id of the user that updated the record last'
;
