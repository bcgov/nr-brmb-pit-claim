...
export class CollectionComponent extends BaseComponent implements OnChanges, AfterViewInit {
    ...
    searchClaimsNumber = undefined;
    searchPolicyNumber = undefined;
    selectedCalculationStatusCode = undefined;
    selectedCropYear = undefined;
    insurancePlan = undefined;
    selectedCreatedByUser = undefined;
    selectedLastUpdatedBy = undefined;
    collectionData: any[];
    ...
    selectFilterUpdated(property, value) {
        let multiple = Array.isArray(this[property]);
        let valueChanged = this[property] != value;
        
        if (multiple || (!multiple && valueChanged && value != null)) {
            this[property] = value;
            this.cdr.detectChanges();
